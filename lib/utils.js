...
exports.checkForUpdates = () => {
  if (!process.env.YTDL_NO_UPDATE && !pkg.version.startsWith('0.0.0-') &&
    ...
    return exports.request('https://api.github.com/repos/abruccii/ytdl-core/contents/package.json', {
      ...
      if (pkgFile.version !== pkg.version && updateWarnTimes++ < 5) {
        ...
        console.warn('\x1b[33mWARNING:\x1B[0m @abrucci/ytdl-core is out of date! Update with "npm install @distube/ytdl-core@latest".');
      }
    }, err => {
